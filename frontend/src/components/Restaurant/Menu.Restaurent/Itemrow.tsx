...
// ─────────────────────────────────────────────────────────────────────────────
// isClosed prop: when true the row renders with .s-item-row.closed class
// which applies grayscale via CSS. AddToCartBtn stays fully active.
// ─────────────────────────────────────────────────────────────────────────────
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 2 }}>
          ...
          <span style={{
            fontSize: 14, fontWeight: 600, color: "#1A0A00",
        ...
        {item.restaurantName && (
          <span style={{ fontSize: 10, color: "#aaa", display: "block", marginBottom: 3 }}>
            {item.restaurantName}
          </span>
        )}
      ...
      {/* AddToCartBtn always active — .s-qty-btn / .s-add-btn have filter:none !important */}
